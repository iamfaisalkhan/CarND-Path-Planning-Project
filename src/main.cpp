      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            vector<double> nextpt0 = getXY(car_s+30, (2+4*lane), map_waypoints_s, map_waypoints_x, map_waypoints_y);
            vector<double> nextpt1 = getXY(car_s+60, (2+4*lane), map_waypoints_s, map_waypoints_x, map_waypoints_y);
            vector<double> nextpt2 = getXY(car_s+90, (2+4*lane), map_waypoints_s, map_waypoints_x, map_waypoints_y);

            ptsx.push_back(nextpt0[0]);
            ptsx.push_back(nextpt1[0]);
            ptsx.push_back(nextpt2[0]);

            ptsy.push_back(nextpt0[1]);
            ptsy.push_back(nextpt1[1]);
            ptsy.push_back(nextpt2[1]);
